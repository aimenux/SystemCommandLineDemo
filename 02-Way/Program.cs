...
public static class Program
{
    public static async Task Main(string[] args)
    {
        ...
        var commandLine = new FluentCommandLineBuilder()
            .AddCommand(commandBuilder =>
            {
                commandBuilder
                    .WithName("upper")
                    .WithArgument<string>(argumentBuilder =>
                    {
                        argumentBuilder
                            .WithName("input");
                    })
                    .WithHandler<string>(input => Console.WriteLine(input.ToUpper()));
            })
            .AddCommand(commandBuilder =>
            {
                commandBuilder
                    ...
                    .WithHandler<string>(input => Console.WriteLine(input.ToLower()));
            }).Build();
